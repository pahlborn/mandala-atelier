...
const Store = {
  prefix: 'mandala-atelier-regal2-29.',
  get(key, fallback) {
    try {
...
/* ===== FILIGRAN – ANFANG ====================================================
   ...
   Alles zwischen diesem Zeichen und „FILIGRAN – ENDE“ ist zusätzlich und
...
WORLDS.push({ id: 'filigran', title: 'Filigran' });

MOTIFS.push(
  {
    id: 'spitzenrad', world: 'filigran', axes: 16,
  ...
  {
    id: 'perlgrat', world: 'filigran', axes: 16,
  ...
  {
    id: 'gitterschale', world: 'filigran', axes: 12,
  ...
  {
    id: 'granulat', world: 'filigran', axes: 12,
  ...
  {
    id: 'tropfensaum', world: 'filigran', axes: 12,
  ...
  {
    id: 'kordelstern', world: 'filigran', axes: 8,
  ...
  {
    id: 'rankengeflecht', world: 'filigran', axes: 8,
...
const Gallery = {
  ...
  open: function () {
    ...
    return new Promise(function (resolve) {
      ...
      let request;
      try {
        request = indexedDB.open('mandala-atelier-regal2-29', 1);
      } catch (err) {
        return resolve();
      }
