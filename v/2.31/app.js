...
const Store = {
  prefix: 'mandala-atelier-regal2-31.',
  get(key, fallback) {
    try {
...
MOTIFS.push(
  ...
  {
    id: 'gitterschale', world: 'feinwerk', axes: 12,
  ...
  {
    id: 'tropfensaum', world: 'feinwerk', axes: 12,
  ...
  {
    id: 'kordelstern', world: 'feinwerk', axes: 8,
  ...
  {
    id: 'rankengeflecht', world: 'feinwerk', axes: 8,
...
const Gallery = {
  ...
  open: function () {
    ...
    return new Promise(function (resolve) {
      ...
      let request;
      try {
        request = indexedDB.open('mandala-atelier-regal2-31', 1);
      } catch (err) {
        return resolve();
      }
